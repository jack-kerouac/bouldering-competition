...
<g:form action="create">
    <div class="row">
        ...
        <div class="small-9 column ${hasErrors(field:'boulder', 'error')}">
            <g:select name="boulder.id" from="${boulders}" optionKey="id" optionValue="${{"${it.section.name} - ${it.grade}"}}"
